...
import com.zhangjian.coherent.databinding.LayoutRealValueProgressBinding
import io.reactivex.Observable
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.Disposable
import java.util.concurrent.TimeUnit

class RealValueActivity : AppCompatActivity() {

    private lateinit var dataBinding: LayoutRealValueProgressBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        dataBinding = DataBindingUtil.setContentView(this, R.layout.layout_real_value_progress)

        dataBinding.viewModel = viewModel

        progressProcess = createRealValueForProgressBar(dataBinding.progressBarCoherent)
